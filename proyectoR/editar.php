...
<?php
    $id = $_GET["id"];
    $sql="SELECT * FROM automovil3 where ID='$id'";
...
?>
 ...
 <form action="procesar_editar.php" method="POST">
    ...
    <p>color</p>
    <form action="procesar_editar.php" method="POST">
        <input type="text" value="<?php echo $mostrar['Motor'] ?>" name="txtcolor">
    <p>año</p>    
    <form action="procesar_editar.php" method="POST">
        <input type="text" value="<?php echo $mostrar['Chasis'] ?>" name="txtaño">
    <p>Precio</p> 
        <form action="procesar_editar.php" method="POST">
